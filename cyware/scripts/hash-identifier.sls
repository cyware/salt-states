...
cyware-scripts-hash-identifier-source:
  file.managed:
...
cyware-scripts-hash-identifier-shebang:
  file.replace:
    - name: /usr/local/bin/hash-id.py
    ...
    - count: 1
    - watch:
      - file: cyware-scripts-hash-identifier-source

cyware-scripts-hash-identifier-formatting:
  file.replace:
    - name: /usr/local/bin/hash-id.py
    - pattern: '\r'
    - repl: ''
    - backup: False
    - watch:
      - file: cyware-scripts-hash-identifier-shebang
