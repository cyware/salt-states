...
cyware-tools-js-patched-source:
  file.managed:
    - name: /usr/local/src/cyware/files/js-1.7.0-mod-c.zip
...
cyware-tools-js-patched-archive:
  archive.extracted:
    - name: /usr/local/src/cyware/js-1.7.0-mod-c
    - source: /usr/local/src/cyware/files/js-1.7.0-mod-c.zip
    - enforce_toplevel: False
    - watch:
      - file: cyware-tools-js-patched-source

cyware-tools-js-patched-binary1:
  file.managed:
    - name: /usr/local/bin/js-file
    - source: /usr/local/src/cyware/js-1.7.0-mod-c/js-1.7.0-mod-c/Linux/js-file
    - mode: 755
    - watch:
      - archive: cyware-tools-js-patched-archive

/usr/local/bin/js-patched:
  file.symlink:
  - target: /usr/local/bin/js-file
  - watch:
    - file: cyware-tools-js-patched-binary1

cyware-tools-js-patched-binary2:
  file.managed:
    - name: /usr/local/bin/js-ascii
    - source: /usr/local/src/cyware/js-1.7.0-mod-c/js-1.7.0-mod-c/Linux/js-ascii
    - mode: 755
    - watch:
      - archive: cyware-tools-js-patched-archive