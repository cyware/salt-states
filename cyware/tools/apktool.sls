...
cyware-tools-apktool-directory:
  file.directory:
...
cyware-tools-apktool-source:
  file.managed:
    ...
    - mode: 755
    - watch:
      - file: cyware-tools-apktool-directory
    - require:
      - file: cyware-tools-apktool-directory

cyware-tools-apktool-wrapper:
  file.managed:
    - name: /usr/local/bin/apktool
    - mode: 755
    - watch:
      - file: cyware-tools-apktool-source
    - contents:
      - '#!/bin/bash'
