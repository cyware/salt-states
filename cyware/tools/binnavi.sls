...
cyware-tools-binnavi-directory:
  file.directory:
...
cyware-tools-binnavi-source:
  file.managed:
    ...
    - mode: 755
    - watch:
      - file: cyware-tools-binnavi-directory
    - require:
      - file: cyware-tools-binnavi-directory

cyware-tools-binnavi-wrapper:
  file.managed:
    - name: /usr/local/bin/binnavi
    - mode: 755
    - watch:
      - file: cyware-tools-binnavi-source
    - contents:
      - '#!/bin/bash'
