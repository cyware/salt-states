...
cyware-python3-packages-dotnetfile-dump:
  file.managed:
    ...
    - mode: 755
    - require:
      - pip: cyware-python3-packages-dotnetfile

cyware-python3-packages-dotnetfile-dump-shebang:
  file.prepend:
    - name: /usr/local/bin/dotnetfile_dump.py
    - text: '#!/usr/bin/env python3'
    - require:
      - file: cyware-python3-packages-dotnetfile-dump
