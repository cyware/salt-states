...
cyware-mitmproxy-source:
  file.managed.:
    - name: /usr/local/src/cyware/files/mitmproxy-6.0.2-linux.tar.gz
...
cyware-mitmproxy-archive:
  archive.extracted:
    - name: /usr/local/bin/
    - source: /usr/local/src/cyware/files/mitmproxy-6.0.2-linux.tar.gz
    - enforce_toplevel: False
    - force: True
    - watch:
      - file: cyware-mitmproxy-source

cyware-mitmproxy-files:
  file.managed:
    - replace: False
    - names:
    ...
    - mode: 755
    - watch:
      - archive: cyware-mitmproxy-archive
