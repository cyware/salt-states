...
cyware-python3-packages-remove-speakeasy:
  pip.removed:
    - name: speakeasy
    - bin_env: /usr/bin/python3

cyware-python3-packages-speakeasy-virtualenv:
  virtualenv.managed:
    - name: /opt/speakeasy
    ...
    - require:
      ...
      - pip: cyware-python3-packages-remove-speakeasy
...
cyware-python3-packages-speakeasy-emuexe:
  file.managed:
    ...
    - mode: 755
    - require:
      - pip: cyware-python3-packages-speakeasy

cyware-python3-packages-speakeasy-emuexe-shebang:
  file.prepend:
    - name: /opt/speakeasy/bin/emu_exe.py
    - text: '#!/opt/speakeasy/bin/python3'
    - require:
      - file: cyware-python3-packages-speakeasy-emuexe

cyware-python3-packages-speakeasy-emudll:
  file.managed:
...
cyware-python3-packages-speakeasy-emudll-shebang:
  file.prepend:
    - name: /opt/speakeasy/bin/emu_dll.py
    - text: '#!/opt/speakeasy/bin/python3'
    - require:
...
cyware-python3-packages-old-speakeasy-wrapper:
  file.absent:
...
{% for tool in tools %}
cyware-python3-packages-speakeasy-{{ tool }}-symlink:
  file.symlink:
