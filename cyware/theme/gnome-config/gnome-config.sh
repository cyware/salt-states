...
# Set the desktop background to black and display the cyware logo in the center.
gsettings set org.gnome.desktop.background picture-uri "file:///usr/local/share/cyware/cyware-logo.png"
